...
public interface IKanbanService
{
    ...
    Task MoveColumnAsync(Guid columnId, int newPosition, string usuario, CancellationToken ct = default);
    ...
    Task<KanbanTaskDto> MoveTaskAsync(Guid taskId, Guid toColumnaId, int? toPosition, string usuario, CancellationToken ct = default);
}
